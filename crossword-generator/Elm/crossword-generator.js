...
var _user$project$Analyzer$generateCrossword = function (_p0) {
	var _p1 = _p0;
	var _p4 = _p1._0;
	var _p3 = _p1._1;
	var _p2 = _p4;
	if (_p2.ctor === '[]') {
			...
			F2(
				function (word, letter) {
					return A2(
						_elm_lang$core$Maybe$map,
						function (i) {
							return {ctor: '_Tuple2', _0: word, _1: i};
						},
						A2(
		...
		return (_elm_lang$core$Native_Utils.cmp(
			...
			_elm_lang$core$List$length(paddings)) < 1) ? _elm_community$maybe_extra$Maybe_Extra$combine(paddings) : _elm_lang$core$Maybe$Nothing;
	}
};
...
var _user$project$App$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('crossword'),
			_1: {ctor: '[]'}
		},
...
var _user$project$App$keyword = 'LOK';
var _user$project$App$words = {
	ctor: '::',
	_0: 'ALA',
	_1: {
		ctor: '::',
...
var _user$project$App$CrosswordKeys = F2(
	function (a, b) {
...
var _user$project$App$Reanalyze = function (a) {
	return {ctor: 'Reanalyze', _0: a};
};
var _user$project$App$init = {
	...
	_0: {
		...
		structure: _user$project$App$noStructure
	},
	_1: A2(
		_elm_lang$core$Task$perform,
		function (_p8) {
